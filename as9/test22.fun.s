...
L6:
	...
	lw 	$s1, 44($sp)	# $s1 := [$sp+44]
	lw 	$s2, 44($sp)	# $s2 := [$sp+44]
	lw 	$s3, 44($sp)	# $s3 := [$sp+44]
	lw 	$s4, 44($sp)	# $s4 := [$sp+44]
	lw 	$s5, 44($sp)	# $s5 := [$sp+44]
	lw 	$s6, 44($sp)	# $s6 := [$sp+44]
	lw 	$s7, 44($sp)	# $s7 := [$sp+44]
_main.epilog:
	addi 	$sp, $sp, 48	# $sp := $sp+48
	jr 	$ra		# also uses: $v0,$s0,$s1,$s2,$s3,$s4,$s5,$s6,$s7
